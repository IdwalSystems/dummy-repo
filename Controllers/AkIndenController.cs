...
namespace MSNK.Controllers
{
    ...
    public class AkIndenController : Controller
    {
            ...
            string searchColumn)
        {
            ...
            var akInden = new List<AkInden>().AsEnumerable();

            if (User.IsInRole("SuperAdmin") || User.IsInRole("Supervisor"))
            {
                akInden = await _akIndenRepo.GetAllIncludeDeletedItemsFiltered(searchString,searchDate1,searchDate2,searchColumn);
            }
            else
            {
                akInden = await _akIndenRepo.GetAllFiltered(searchString,searchDate1,searchDate2,searchColumn);
            }
