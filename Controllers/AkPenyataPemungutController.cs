...
namespace MSNK.Controllers
{
    ...
    public class AkPenyataPemungutController : Controller
    {
        ...
        public async Task<IActionResult> Create(AkPenyataPemungut akPenyataPemungut, int AkBankId)
        {
            ...
            if (ModelState.IsValid)
            {
                if (akPenyataPemungut != null && AkBankId != 0)
                {
                    ...
                    //insert applog
                    await AddLogAsync("Tambah", m.NoDokumen, m.NoDokumen, 0, m.Jumlah);
                    //insert applog end
        ...
        public async Task<IActionResult> Edit(int id,AkPenyataPemungut akPenyataPemungut)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    //insert applog
                    await AddLogAsync("Ubah", "Ubah Data", akPenyataPemungut.NoDokumen, id, akPenyataPemungut.Jumlah);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            //insert applog
            await AddLogAsync("Hapus", obj.NoDokumen, obj.NoDokumen, id, obj.Jumlah);
            //insert applog end
        ...
        public async Task<IActionResult> RollBack(int id)
        {
            ...
            //insert applog
            await AddLogAsync("Rollback", "Rollback Data", obj.NoDokumen, (int)id, obj.Jumlah);
